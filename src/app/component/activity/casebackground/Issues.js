define(function (require) {
    ...
    var template = require('text!component/activity/casebackground/Issues.hbs');
    ...
    var Menu = require('component/activity/casebackground/menu/Menu');
    var Issue = require('component/activity/casebackground/card/issue/Issue');
    var Evidence = require('component/activity/casebackground/card/evidence/Evidence');
    var IssueGroup = require('component/activity/casebackground/card/issuegroup/IssueGroup');
    var ActionButton = require('component/actionbutton/ActionButton');
    var Score = require('component/activity/casebackground/score/Score');
    ...
    return Component.extend({
        ...
        mergedYet: false,
        template: template,
        classes: 'casebackground',
        styles: 'component/activity/casebackground/Issues.css',
